...
\begin{figure}[H]
    \centering
    \includegraphics[width=18cm]{p1_gn.png}  %需调整
...
\begin{figure}[H]
    \centering
    \includegraphics[width=18cm]{p2_gn.png}  %需调整
...
\begin{figure}[H]
    \centering
    \includegraphics[width=18cm]{p3_gn.png}  %需调整
...
\begin{figure}[H]
    \centering
    \includegraphics[width=18cm]{p4_gn.png}  %需调整
...
\begin{figure}[H]
    \centering
    \includegraphics[width=18cm]{p5_gn.png}  %需调整
